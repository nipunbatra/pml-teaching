...
\begin{frame}{MLE for $\sigma$ for normally distributed data}
    ...
    \begin{frame}
        ...
        \begin{frame}{Bias }
            \begin{figure}
                \includegraphics{notebooks/figures/mle/biased-mle-normal-5-0.pdf}
            \end{figure}
        ...
        \end{frame}
             ...
             \begin{frame}{Bias }
            \begin{figure}
                \includegraphics{notebooks/figures/mle/biased-mle-normal-5-1.pdf}
            \end{figure}
        ...
        \end{frame}
             ...
             \begin{frame}{Bias }
            \begin{figure}
                \includegraphics{notebooks/figures/mle/biased-mle-normal-5-2.pdf}
            \end{figure}
        ...
        \end{frame}
             ...
             \begin{frame}{Bias }
            \begin{figure}
                \includegraphics{notebooks/figures/mle/biased-mle-normal-5-3.pdf}
            \end{figure}
        ...
        \end{frame}
             ...
             \begin{frame}{Bias }
            \begin{figure}
                \includegraphics{notebooks/figures/mle/biased-mle-normal-5-4.pdf}
            \end{figure}
        ...
        \end{frame}
             ...
             \begin{frame}{Bias }
            \begin{figure}
                \includegraphics{notebooks/figures/mle/biased-mle-normal-5-5.pdf}
            \end{figure}
