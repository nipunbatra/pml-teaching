...
\begin{frame}[fragile]{Estimating Pi using Monte Carlo (Part 1)}
    ...
    \begin{frame}{Rejection Sampling}
        \begin{figure}
            \centering
            \includegraphics[width=0.8\textwidth]{notebooks/figures/sampling/rejection-sampling--1.0-False-False-False-False-False-False.pdf}
        \end{figure}
    ...
    \begin{frame}{Rejection Sampling}
        \begin{figure}
            \centering
            \includegraphics[width=0.8\textwidth]{notebooks/figures/sampling/rejection-sampling--1.0-True-False-False-False-False-False.pdf}
        \end{figure}
    ...
    \begin{frame}{Rejection Sampling}
        \begin{figure}
            \centering
            \includegraphics[width=0.8\textwidth]{notebooks/figures/sampling/rejection-sampling--1.0-True-True-False-False-False-False.pdf}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}{Rejection Sampling}
        \begin{figure}
            \centering
            \includegraphics[width=0.8\textwidth]{notebooks/figures/sampling/rejection-sampling--1.0-True-True-True-False-False-False.pdf}
        \end{figure}
    \end{frame}
