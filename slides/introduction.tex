...
\begin{frame}{Questions}
    \begin{itemize}
        ...
        \item What is the link between atom bomb and this course?
        \item Given a set of hyperparameters, we previously used grid search to find the best hyperparameters. Is there a better way?
...
\begin{frame}{Bayes Rule}
    ...
    \begin{itemize}
        \item $P(\theta|D)$ is called the posterior
        \item $P(D|\theta)$ is called the likelihood
        \item $P(\theta)$ is called the prior
        \item $P(D)$ is called the evidence
    \end{itemize}
