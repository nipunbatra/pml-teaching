...
\begin{frame}{Pop Quiz}
    ...
    \begin{figure}
        \includegraphics{../figures/mle/mle-example.pdf}
    \end{figure}
...
\begin{frame}{Pop Quiz}
    Let us plot the probability density functions of the three courses. 
    \begin{figure}
        \includegraphics{../figures/mle/mle-example-2.pdf}
    \end{figure}
...
We ask two students their marks. The first student says 82 and the second student says 72. Which course do you think they are from? Assumption: Both are from the same course or different courses?
