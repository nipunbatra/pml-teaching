...
\foreach \i in {0.0,0.2,0.4,0.6,0.8}{
    ...
    \begin{figure}
        \includegraphics[width=0.55\textwidth]{figures/gaussian_\i.pdf}
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
        \includegraphics[width=0.55\textwidth]{figures/gaussian_mu_2.pdf}
    \end{figure}
    \end{frame}
...
%     \end{equation*}
%     \begin{figure}
%         \includegraphics[width=0.9\textwidth]{figures/vertical.pdf}
%     \end{figure}
% \end{frame}
...
%     \end{equations*}
%     \begin{figure}
%         \includegraphics[width=0.9\textwidth]{figures/conditional_\i.pdf}
%     \end{figure}
...
%     \end{equations*}
%     \begin{figure}
%         \includegraphics[width=0.9\textwidth]{figures/marginal_\i.pdf}
%     \end{figure}
